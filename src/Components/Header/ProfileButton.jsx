    ...
    return (
        <div className="relative flex items-center">
            <button onClick={() => setPanel(!panel)} className="mx-4" type="button">
                <img src={"/images/profile.png"} className="object-cover w-10 h-10 rounded-full bg-black" />
            </button>
            {
                panel ?   
                <div className="z-10 xl:w-[24vw] lg:w-[28vw] md:w-[32vw] sm:w-[40vw] w-[80vw] rounded-lg inline-block bg-white shadow absolute right-0 top-12">
                    ...
                    <Link onClick={() => setPanel(!false)} href="/dashboard" className="flex items-center justify-between gap-4 p-4 rounded-b-md hover:text-primary-0 transition ">
                        <div className="text-left">
